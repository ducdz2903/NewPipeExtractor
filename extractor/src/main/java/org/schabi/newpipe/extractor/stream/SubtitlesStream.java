 ...
 *
 * <p>
 * If the language code represents a translated language, append a note to indicate this.
 * </p>
 *
...
public Builder setLanguageCode(@Nonnull final String languageCode) {
    if (languageCode.contains("-translated")) {
        this.languageCode = languageCode.replace("-translated", "") + " (Translated)";
    } else {
